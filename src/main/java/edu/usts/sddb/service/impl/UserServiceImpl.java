...
public class UserServiceImpl implements UserService {
    ...
    public TeacherProfile getTeacherProfile(String us_id) {
        ...
        /*int p_view = user.getUs_view();
        userProfile.setP_view(p_view);   //此为用户浏览次数，后期待添加

        int p_file_count = fileService.findCountByUserId(us_id);
        userProfile.setP_file_count(p_file_count);   //此为用户贡献资料次数，后期待添加
        ...
        String p_email = user.getUs_email();
        userProfile.setP_email(p_email);*/
        userProfile.setP_view(2);
        userProfile.setP_file_count(1); 
        userProfile.setP_intro("11");
        userProfile.setP_qq("11");
        userProfile.setP_email("11");
